...
{
    const char* pszTimestamp = "Plutus is envisaged so that he would be able to dispense his gifts without prejudice;";
    const CScript genesisOutputScript = CScript() << ParseHex("04a379426f68e89d8eb3a1063d0263fa2793a8420af3084ad56ea69d69137b5c0eaa302744710125a53cd98c0abb9d4fb0e88d258c9895305e73f4af25d62ccf88") << OP_CHECKSIG;
    //was const CScript genesisOutputScript = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("00008efa6924a1a9a5e31e7f0586af5e794dc40a3eb8d8863c9c3e51ce8894a3"); // was 0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8
        ...
        consensus.nMinimumChainWork = uint256S("0x00"); //was 0x000000000000000000000000000000000000000000723d3581fe1bd55373540a

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); //was 0x0000000000000000003b9ce759c2a087d52abc4266f8f4ebd6d768b89defa50a//477890
         ...
         */
        pchMessageStart[0] = 0x14; //was 0xe1;
        ...
        genesis = CreateGenesisBlock(1518558625, 3131108260, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash(consensus);
        assert(consensus.hashGenesisBlock == uint256S("00000000af1da9e603a7442c5a0fa1c1885ee583990234b467894404b20a6119"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,100); //prefix: h was 128 t);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x02, 0x65, 0x1F, 0x71}; //was {0x04, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x02, 0x35, 0x5E, 0x56}; //was {0x04, 0x88, 0xAD, 0xE4};
...
//            1507871959, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); //was 0x0000000002e9e7b00e1f6dc5123a04aad68dd0f0968d8c7aa45f6640795c37b1 //1135275

        pchMessageStart[0] = 0x5B; //was 0xe1;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,83); //a was 111 m or n);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,195); // was 196);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,132); //v was 239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x14, 0xBF, 0x4C, 0x44}; //was {0x04, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x14, 0x5B, 0x2C, 0x19}; //was {0x04, 0x35, 0x83, 0x94};
...
public:
    CRegTestParams() {
        ...
        //based on https://github.com/AchieveCoin/AchieveCoin/issues/78
        consensus.nPowAveragingWindow = 30;
        ...
        consensus.hashGenesisBlock = genesis.GetHash(consensus);
        assert(consensus.hashGenesisBlock == uint256S("05d7ce9e87dbb809b65c23bee5d85281fab2e46f015d177adc6ecc4af013d89d"));
        assert(genesis.hashMerkleRoot == uint256S("91ced1a84f4aa30ae7b64f1b3a99dfe72c1ba1838bbe596e04e95d1e9d9d7a4a"));
