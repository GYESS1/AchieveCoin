...
Source10:	https://raw.githubusercontent.com/AchieveCoin/AchieveCoin/master/contrib/debian/examples/achievecoin.conf
...
cp -p %{SOURCE10} ./achievecoin.conf.example
tar -zxf %{SOURCE1}
...
cat <<EOF > %{buildroot}%{_tmpfilesdir}/achievecoin.conf
d /run/bitcoind 0750 bitcoin bitcoin -
EOF
touch -a -m -t 201504280000 %{buildroot}%{_tmpfilesdir}/achievecoin.conf
...
CONFIG_FILE="%{_sysconfdir}/bitcoin/achievecoin.conf"
DATA_DIR="%{_localstatedir}/lib/bitcoin"
PID_FILE="/run/bitcoind/achd.pid"
EOF
...
%doc COPYING achievecoin.conf.example doc/README.md doc/bips.md doc/files.md doc/multiwallet-qt.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
...
%defattr(-,root,root,-)
%license COPYING db-%{bdbv}.NC-LICENSE
%doc COPYING achievecoin.conf.example doc/README.md doc/REST-interface.md doc/bips.md doc/dnsseed-policy.md doc/files.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
%attr(0755,root,root) %{_sbindir}/bitcoind
%attr(0644,root,root) %{_tmpfilesdir}/achievecoin.conf
...
%defattr(-,root,root,-)
%license COPYING
%doc COPYING achievecoin.conf.example doc/README.md
